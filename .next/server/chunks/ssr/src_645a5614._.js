...
"[project]/src/hooks/useCsrf.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useCsrf() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchCsrfToken() {
            const tokenFromCookie = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('csrf-token');
            if (tokenFromCookie) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCsrf$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useCsrf.ts [app-ssr] (ecmascript)");
...
function Home() {
    ...
    const csrfToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCsrf$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCsrf"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (csrfToken) {
    ...
    const handleCreateBoard = async ()=>{
        ...
        if (name) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithCsrf"])('/api/boards', {
                method: 'POST',
                body: JSON.stringify({
                    name
                })
        ...
        if (active.id !== over.id) {
            ...
            if (active.data.current?.type === 'List' && over.data.current?.type === 'List') {
                setLists((lists)=>{
                    ...
                    newLists.forEach((list, index)=>{
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithCsrf"])(`/api/lists/${list._id}`, {
                            method: 'PUT',
                            body: JSON.stringify({
                                position: index
                            })
            ...
            if (active.data.current?.type === 'Card') {
                setCards((currentCards)=>{
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithCsrf"])(`/api/cards/${active.id}`, {
                        method: 'PUT',
                        body: JSON.stringify({
                            position: overIndex,
                            list: overListId
