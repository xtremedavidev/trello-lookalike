...
"[project]/src/libs/fetch.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function fetchWithCsrf(url, options = {}) {
    const csrfToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('csrf-token');
    const headers = {
        ...options.headers,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/libs/fetch.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithAuth"])('/api/boards').then((res)=>res.json()).then((data)=>{
            setBoards(data);
            if (data.length > 0) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (activeBoard) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/boards/${activeBoard._id}`).then((res)=>res.json()).then((data)=>{
                setLists(data.lists);
                setCards(data.cards);
    ...
    const handleCreateBoard = async ()=>{
        ...
        if (name) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithAuth"])('/api/boards', {
                method: 'POST',
                body: JSON.stringify({
                    name
                })
        ...
        if (active.id !== over.id) {
            ...
            if (active.data.current?.type === 'List' && over.data.current?.type === 'List') {
                setLists((lists)=>{
                    ...
                    const newLists = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayMove"])(lists, activeIndex, overIndex);
                    // API call to update list position
                    newLists.forEach((list, index)=>{
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/lists/${list._id}`, {
                            method: 'PUT',
                            body: JSON.stringify({
                                position: index
                            })
            ...
            if (active.data.current?.type === 'Card') {
                setCards((currentCards)=>{
                    ...
                    let newCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayMove"])(currentCards, activeIndex, overIndex);
                    ...
                    if (overListId && newCards[activeIndex].list !== overListId) {
                        ...
                        newCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayMove"])(newCards, activeIndex, overIndex);
                    }
                    // API call to update card position and list
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/cards/${active.id}`, {
                        method: 'PUT',
                        body: JSON.stringify({
                            position: overIndex,
                            list: overListId
...
//# sourceMappingURL=src_5b1a2598._.js.map