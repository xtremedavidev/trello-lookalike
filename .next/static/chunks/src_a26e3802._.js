...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])('/api/boards').then({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (activeBoard) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/boards/${activeBoard._id}`).then({
                    "Home.useEffect": (res)=>res.json()
                }["Home.useEffect"]).then({
                    "Home.useEffect": (data)=>{
                        setLists(data.lists);
    ...
    const handleCreateBoard = async ()=>{
        ...
        if (name) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])('/api/boards', {
                method: 'POST',
                body: JSON.stringify({
                    name
                })
        ...
        if (active.id !== over.id) {
            ...
            if (active.data.current?.type === 'List' && over.data.current?.type === 'List') {
                setLists((lists)=>{
                    ...
                    newLists.forEach((list, index)=>{
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/lists/${list._id}`, {
                            method: 'PUT',
                            body: JSON.stringify({
                                position: index
                            })
            ...
            if (active.data.current?.type === 'Card') {
                setCards((currentCards)=>{
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/cards/${active.id}`, {
                        method: 'PUT',
                        body: JSON.stringify({
                            position: overIndex,
                            list: overListId
...
_s(Home, "ine13z0o/qeL8CteY663awUOvhQ=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_a26e3802._.js.map