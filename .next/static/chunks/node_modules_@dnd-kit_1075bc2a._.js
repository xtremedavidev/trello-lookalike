(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push([
  typeof document === "object" ? document.currentScript : undefined,
  {
      ...
      (__turbopack_context__) => {
        ...
        var { g: global, __dirname } = __turbopack_context__;
        {
          ...
          function isWindow(element) {
            ...
            return (
              elementString === "[object Window]" || // In Electron context the Window object serializes to [object global]
          ...
          function getWindow(target) {
            ...
            return (_target$ownerDocument =
              (_target$ownerDocument2 = target.ownerDocument) == null
                ? void 0
                : _target$ownerDocument2.defaultView) != null
    ...
    "[project]/node_modules/@dnd-kit/accessibility/dist/accessibility.esm.js [app-client] (ecmascript)":
      (__turbopack_context__) => {
        "use strict";
    ...
    "[project]/node_modules/@dnd-kit/core/dist/core.esm.js [app-client] (ecmascript)":
      (__turbopack_context__) => {
        ...
        var { g: global, __dirname } = __turbopack_context__;
        {
          ...
          var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$accessibility$2f$dist$2f$accessibility$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ =
            __turbopack_context__.i(
              "[project]/node_modules/@dnd-kit/accessibility/dist/accessibility.esm.js [app-client] (ecmascript)",
            );
          ...
          function Accessibility(_ref) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$accessibility$2f$dist$2f$accessibility$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
              "useAnnouncement"
            ])();
              ...
              if (rect) {
                ...
                const distances = corners.reduce(
                  (accumulator, corner, index) => {
                    return (
                      accumulator + distanceBetween(rectCorners[index], corner)
                    );
                  },
                  0,
                );
           ...
           */ const pointerWithin = (_ref) => {
            let { droppableContainers, droppableRects, pointerCoordinates } =
              _ref;
          ...
          function getScrollDirectionAndSpeed(
            ...
            if (
              !isRight &&
              right >= scrollContainerRect.right - threshold.width
            ) {
              // Scroll Right
                  ...
                  Object.defineProperty(this, key, {
                    get: () => {
                      const currentOffsets =
                        getScrollOffset(scrollableAncestors);
          ...
          KeyboardSensor.activators = [
            {
              ...
              handler: (event, _ref, _ref2) => {
                let { keyboardCodes = defaultKeyboardCodes, onActivation } =
                  _ref;
                let { active } = _ref2;
                ...
                "useAutoScroller.useEffect": () => {
                  ...
                  for (const scrollContainer of sortedScrollableAncestors) {
                    if (
                      (canScroll == null
                        ? void 0
                        : canScroll(scrollContainer)) === false
                    ) {
                      continue;
                    }
          ...
          function useCachedNode(draggableNodes, id) {
            const draggableNode =
              id != null ? draggableNodes.get(id) : undefined;
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$utilities$2f$dist$2f$utilities$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            ...
            ])(
              {
                "useInitialValue.useLazyMemo": (previousValue) => {
                  ...
                  return typeof computeFn === "function"
                    ? computeFn(value)
                    : value;
                },
            ...
            function measureRect() {
              setRect((currentRect) => {
                ...
                if (element.isConnected === false) {
                  ...
                  return (_ref =
                    currentRect != null ? currentRect : fallbackRect) != null
                    ? _ref
                    : null;
                }
            ...
            ])(
              {
                "useScrollOffsets.useEffect": () => {
                  ...
                  if (elements !== previousElements) {
                    ...
                    setScrollCoordinates(
                      entries.length ? new Map(entries) : null,
                    );
                  ...
                  draggable: {
                    ...
                    translate: {
                      x:
                        ...
                        state.draggable.initialCoordinates.x,
                      y:
                        action.coordinates.y -
                        state.draggable.initialCoordinates.y,
                    },
                  },
                };
              case Action.DragEnd:
          ...
          __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                ...
                "DndContext.DndContext.useMemo[active]": () => {
                  ...
                  return activeId != null
                    ? {
                        ...
                        data:
                          (_node$data = node == null ? void 0 : node.data) !=
                          null
                            ? _node$data
                            : defaultData,
                        rect: activeRects,
            ...
            useLayoutShiftScrollCompensation({
              activeNode:
                activeId != null ? draggableNodes.get(activeId) : null,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$utilities$2f$dist$2f$utilities$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            ...
            ])(
              {
                "AnimationManager.useIsomorphicLayoutEffect": () => {
                  ...
                  const key =
                    clonedChildren == null ? void 0 : clonedChildren.key;
                  const id =
          ...
          function createDefaultDropAnimation(options) {
            ...
            return (_ref4) => {
              ...
              if (
                JSON.stringify(firstKeyframe) === JSON.stringify(lastKeyframe)
              ) {
      ...
      (__turbopack_context__) => {
        ...
        var { g: global, __dirname } = __turbopack_context__;
        {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
            ...
            ])(
              {
                "SortableContext.useMemo[items]": () =>
                  userDefinedItems.map(
                    {
                      "SortableContext.useMemo[items]": (item) =>
          ...
          const disabledTransition =
            /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$utilities$2f$dist$2f$utilities$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
              "CSS"
            ].Transition.toString({
          ...
          function useSortable(_ref) {
            ...
            const disabled = normalizeLocalDisabled(
              localDisabled,
              globalDisabled,
            );
            ...
            const itemsAfterCurrentSortable = (0,
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
              "useMemo"
            ])(
              {
            ...
            const strategy =
              localStrategy != null ? localStrategy : globalStrategy;
            const finalTransform = displaceItem
              ? dragSourceDisplacement != null
            ...
            return {
              ...
              setDraggableNodeRef,
              transform:
                derivedTransform != null ? derivedTransform : finalTransform,
            ...
            function getTransition() {
              ...
              if (isSorting || shouldAnimateLayoutChanges) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$utilities$2f$dist$2f$utilities$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                  "CSS"
                ].Transition.toString({
                  ...transition,
                  property: transitionProperty,
            ...
            return {
              draggable:
                (_localDisabled$dragga =
                  localDisabled == null ? void 0 : localDisabled.draggable) !=
                null
                  ? _localDisabled$dragga
                  : globalDisabled.draggable,
              droppable:
                (_localDisabled$droppa =
                  localDisabled == null ? void 0 : localDisabled.droppable) !=
                null
                  ? _localDisabled$droppa
          ...
          const sortableKeyboardCoordinates = (event, _ref) => {
            ...
            if (directions.includes(event.code)) {
              ...
              droppableContainers.getEnabled().forEach((entry) => {
                ...
                switch (event.code) {
                  case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                    "KeyboardCode"
                  ].Down:
              ...
              if (closestId != null) {
                ...
                const newRect = newDroppable
                  ...
                  : null;
                const newNode =
                  newDroppable == null ? void 0 : newDroppable.node.current;
                if (newNode && newRect && activeDroppable && newDroppable) {
                  const newScrollAncestors = (0,
                  __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__[
                  ...
                  const hasSameContainer = isSameContainer(
                    activeDroppable,
                    newDroppable,
                  );
...
//# sourceMappingURL=node_modules_%40dnd-kit_1075bc2a._.js.map
