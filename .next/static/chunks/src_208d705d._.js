...
_s(List, "J6dlogBQXC0ZRQzlV9OGWuiF4gU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSortable"]
    ];
});
...
"[project]/src/hooks/useCsrf.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCsrf.useEffect": ()=>{
            async function fetchCsrfToken() {
                const tokenFromCookie = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('csrf-token');
                if (tokenFromCookie) {
...
_s(useCsrf, "h0iJHrpWOR5tdhG5IgOMfPvARlE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/libs/fetch.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function fetchWithCsrf(url, options = {}) {
    const csrfToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('csrf-token');
    const headers = {
        ...options.headers,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCsrf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useCsrf.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/libs/fetch.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function Home() {
    ...
    const csrfToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCsrf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCsrf"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (csrfToken) {
                fetch('/api/boards').then({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (activeBoard && csrfToken) {
                ...
                fetch(`/api/boards/${activeBoard._id}`).then({
                    "Home.useEffect": (res)=>res.json()
                }["Home.useEffect"]).then({
                    "Home.useEffect": (data)=>{
                        setLists(data.lists);
    ...
    const handleCreateBoard = async ()=>{
        ...
        if (name) {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithCsrf"])('/api/boards', {
                method: 'POST',
                body: JSON.stringify({
                    name
                })
        ...
        if (active.id !== over.id) {
            ...
            if (active.data.current?.type === 'List' && over.data.current?.type === 'List') {
                setLists((lists)=>{
                    ...
                    newLists.forEach((list, index)=>{
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithCsrf"])(`/api/lists/${list._id}`, {
                            method: 'PUT',
                            body: JSON.stringify({
                                position: index
                            })
            ...
            if (active.data.current?.type === 'Card') {
                setCards((currentCards)=>{
                    ...
                    let newCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayMove"])(currentCards, activeIndex, overIndex);
                    ...
                    if (overListId && newCards[activeIndex].list !== overListId) {
                        ...
                        newCards = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayMove"])(newCards, activeIndex, overIndex);
                    }
                    // API call to update card position and list
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$fetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithCsrf"])(`/api/cards/${active.id}`, {
                        method: 'PUT',
                        body: JSON.stringify({
                            position: overIndex,
                            list: overListId
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: boards.map((board)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                variant: activeBoard?._id === board._id ? 'secondary' : 'ghost',
...
_s(Home, "SuRvX+xHypofjSg+1J2Cwfsnr78=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCsrf$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCsrf"]
    ];
});
_c = Home;
var _c;
...
//# sourceMappingURL=src_208d705d._.js.map