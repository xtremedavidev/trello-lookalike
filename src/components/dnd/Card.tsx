...
export function Card({ card, listId, onDelete }: { 
  card: CardType, 
  listId: string,
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-2">
          <div className="font-medium text-gray-700 dark:text-white break-words">{card.title}</div>
          ...
          {card.description && (
            <div className="text-sm text-gray-500 dark:text-gray-400 line-clamp-2">{card.description}</div>
          )}
      ...
      {isEditing && (
        ...
        >
          ...
          >
            <div className="p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Edit Card</h3>
              {error && (
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) => setEditedCard({ ...editedCard, isCompleted: e.target.checked })}
                    className="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700"
                  />
                  <label htmlFor={`isCompleted-${card._id}`} className="ml-2 text-sm text-gray-700 dark:text-gray-300">
                    Mark as completed
                  </label>
                </div>
              </div>
